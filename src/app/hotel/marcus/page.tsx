    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-lg font-medium rounded-lg hover:shadow-2xl hover:shadow-amber-500/50 transition-all"
          >
      ...
      <section className="relative py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-amber-900/20 to-orange-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            ...
            <div className="bg-gradient-to-br from-amber-900/20 to-orange-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <MessageCircle className="w-12 h-12 text-amber-400 mb-4" />
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-transparent to-amber-950/20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-red-900/20 to-orange-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <div className="flex items-center gap-2 mb-4">
                <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
