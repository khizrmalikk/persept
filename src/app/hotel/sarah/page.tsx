  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-950 via-black to-blue-950" />
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">
            Meet Sarah
          </h1>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-500 to-blue-500 text-white text-lg font-medium rounded-lg hover:shadow-2xl hover:shadow-indigo-500/50 transition-all"
          >
      ...
      <section className="relative py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-indigo-900/20 to-blue-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <MessageCircle className="w-12 h-12 text-indigo-400 mb-4" />
