      ...
      <section className="relative overflow-hidden pt-24 py-16 sm:py-20 md:py-28 lg:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <FadeUp delay={0.2}>
              <p className="mt-4 text-[clamp(1rem,1.5vw,1.15rem)] leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            {[
              ...
              <SlideIn key={step.num} delay={i * 0.1}>
                <div className="text-center">
                  <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl text-[20px] font-bold mb-4"
                    style={{
          ...
          <div className="grid gap-8 md:grid-cols-4 text-center">
            {[
              ...
              <SlideIn key={stat.label} delay={i * 0.1}>
                <div>
                  <div className="text-[clamp(2rem,4vw,3rem)] font-bold mb-2" style={{ color: 'var(--color-primary)' }}>
                    {stat.value}
                  </div>
                  <p className="text-[14px]" style={{ color: 'var(--color-text-muted)' }}>{stat.label}</p>
                </div>
              </SlideIn>
            ))}
          </div>
      ...
      <section className="relative py-16 sm:py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="card-retro p-8 sm:p-12">
            ...
            <FadeUp delay={0.1}>
              <p className="mt-4 text-[15px] leading-relaxed max-w-2xl mx-auto" style={{ color: 'var(--color-text-muted)' }}>
