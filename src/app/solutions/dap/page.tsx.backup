    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              target="_blank"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-lg font-medium rounded-lg hover:shadow-2xl hover:shadow-purple-500/50 transition-all"
            >
              Try Demo
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-transparent to-purple-950/20">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
              <Calculator className="w-12 h-12 text-purple-400 mb-4" />
      ...
      <section className="relative py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-purple-900/10 to-transparent border border-white/10 rounded-2xl p-8 text-center">
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-transparent to-purple-950/20">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm border border-white/10 rounded-3xl p-12">
            ...
            <div className="space-y-4 text-white/70 mb-8">
              ...
              <p>
                <strong className="text-purple-400">Settled in just 2 transactions!</strong>
              </p>
            </div>
            <div className="text-center">
              <Link
